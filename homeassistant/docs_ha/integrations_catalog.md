...
| `mikrotik_switchos` | Mikrotik `http://10.0.10.2/` | loaded | CSS326 SwitchOS ports, link, traffic, reboot. Fork HACS `hacs-switchos` 0.1.0. |
...
| `mikrotik_switchos` | 0.1.0 | SwitchOS (fork) |
