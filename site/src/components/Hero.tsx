...
export function Hero() {
  ...
  return (
    <header className="relative flex min-h-[100svh] flex-col justify-end overflow-hidden bg-night">
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0"
        style={{
          maskImage:
            'linear-gradient(to bottom, #000 0%, #000 42%, rgba(0,0,0,0.55) 68%, transparent 100%)',
          WebkitMaskImage:
            'linear-gradient(to bottom, #000 0%, #000 42%, rgba(0,0,0,0.55) 68%, transparent 100%)',
        }}
      >
      ...
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-night via-night/70 to-night/20" />
